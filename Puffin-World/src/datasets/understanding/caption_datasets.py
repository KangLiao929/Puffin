    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # text-to-text understanding, offering the enhanced caption for the generation
                ...
                caption_cot = self._read_json(data_sample['annotation'].replace('train_scene_cam', 'train_thinking'), 
                ...
                #print(f"Caption with CoT text2text: {caption_cot}")  # Debug print to check the CoT caption
            ...
            print(f"Error when reading understanding {self.data_path}:{self.data_list[idx]}: {e}", flush=True)
            raise e
            #return self._retry()
