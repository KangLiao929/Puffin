...
from src.dust3r.datasets.scannet import ScanNet_Multi

class CaptionDatasetGen(ScanNet_Multi):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        # get multi-view data from DL3DV and detach selected ones for training
