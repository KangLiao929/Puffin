...
class CaptionDatasetGen(PuffinOmni_Multi):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        # GT per-frame perspective-field angles (radians, plus k1).
        # Stored as space-separated strings to match the cam_pose convention.
        # Order: roll pitch vfov k1.
        gt_cam_params = []
        for view in views:
