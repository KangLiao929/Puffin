...
from src.dust3r.datasets.mvs_synth import MVS_Synth_Multi

class CaptionDatasetGen(MVS_Synth_Multi):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        # get multi-view data from MVS Synth and detach selected ones for training
