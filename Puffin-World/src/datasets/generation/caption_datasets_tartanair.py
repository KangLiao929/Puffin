...
from src.dust3r.datasets.tartanair import TartanAir_Multi

class CaptionDatasetGen(TartanAir_Multi):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        # get multi-view data from TartanAir and detach selected ones for training
