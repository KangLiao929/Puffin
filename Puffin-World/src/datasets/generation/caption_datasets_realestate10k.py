...
from src.dust3r.datasets.realestate10k import RE10K_Multi


class CaptionDatasetGen(RE10K_Multi):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        # get multi-view data from RE10K and detach selected ones for training
