...
suffix = " Then reason its spatial distribution and estimate its camera parameters (roll, pitch, field-of-view, and radial distortion)."
heads = [
...
dataset = dict(type=CaptionDataset,
               ...
               data_path='/mnt/afs_100t/NTU_slab/kliao/data/Puffin-Pro/summary_scene_cam_15M.json',
               ceph_folder=None,
               ceph_config=None,
               )
