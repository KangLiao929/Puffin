...
from src.models.radiov4.hf_model import RADIOModel
from diffusers import AutoencoderKL, FlowMatchEulerDiscreteScheduler
from transformers import AutoModelForCausalLM, AutoTokenizer
from configs.datasets.processors import prompt_template

llm_name_or_path = '/mnt/afs_100t/NTU_slab/kliao/models/Qwen2.5-1.5B-Instruct'
sd3_model_name_or_path = "/mnt/afs_100t/NTU_slab/kliao/models/stable-diffusion-3.5-large"
vision_encoder_name_or_path = "/mnt/afs_100t/NTU_slab/kliao/models/C-RADIOv4-H"
scheduler_cus_path = "configs/scheduler_cus"
...
model = dict(type=Qwen2p5RadioStableDiffusion3HFDynamic,
             ...
             test_scheduler=dict(
                 ...
                 pretrained_model_name_or_path=scheduler_cus_path),
